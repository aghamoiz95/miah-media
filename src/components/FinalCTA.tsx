    ...
    <section className="relative py-48 px-6 flex items-center justify-center overflow-hidden bg-[#121214]" id="commission">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <Link to="/contact" className="w-full sm:w-auto border border-[#e0c88f] bg-[#e0c88f] px-10 py-4 font-sans text-xs font-semibold uppercase tracking-[0.2em] text-[#0a0a0b] transition-all hover:bg-transparent hover:text-[#e0c88f] text-center">
            Submit Enquiry
          </Link>
